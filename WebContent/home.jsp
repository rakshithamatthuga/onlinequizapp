...
<div style="position:absolute;top:50px;left:1110px">
Logged as
</div>
<div style="position:absolute;top:80px;left:1110px">
 <a href="#" class="button username">${sessionScope.user}</a>

</div>

<div style="position:absolute;top:100px;left:1150px">
